...
export const Privacy: React.FC<PrivacyProps> = ({ onClose }) => {
  return (
    <div className="w-full max-w-3xl mx-auto p-1 animate-in zoom-in-95 duration-200">
       <div className="bg-plex-slate/60 backdrop-blur-xl rounded-2xl border border-white/10 shadow-2xl overflow-hidden p-6 md:p-10">
