...
export const About: React.FC<AboutProps> = ({ onClose, onDonate }) => {
  return (
    <div className="w-full max-w-2xl mx-auto p-1 animate-in zoom-in-95 duration-200">
      <div className="bg-plex-slate/60 backdrop-blur-xl rounded-2xl border border-white/10 shadow-2xl overflow-hidden">
        <div className="p-6 md:p-10">
          ...
          <div className="space-y-6 text-gray-300 leading-relaxed font-light">
            ...
            <div className="bg-black/20 p-8 rounded-xl border border-white/5 mt-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center flex-wrap">
                <a 
                  ...
                  className="flex items-center justify-center gap-3 px-6 py-3 bg-white/5 rounded-lg hover:bg-white/10 transition-colors border border-white/10 group min-w-[150px]"
                >
                ...
                <button 
                  onClick={onDonate}
                  className="flex items-center justify-center gap-3 px-6 py-3 bg-plex-orange/10 rounded-lg hover:bg-plex-orange/20 transition-colors border border-plex-orange/20 group min-w-[150px]"
                >
                   <svg className="w-5 h-5 text-plex-orange group-hover:text-yellow-400 transition-colors" fill="currentColor" viewBox="0 0 24 24"><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/></svg>
                   <span className="text-plex-orange group-hover:text-yellow-400 font-medium">Support Me</span>
                </button>
              </div>
            </div>
          </div>
